...
private Label loginLabel = new Label("Please sign in to Google in order to access Stock Watcher.");
...
/**  * Entry point method.  */  public void onModuleLoad() {  
	// Check login status using the login service.
...
private void loadStocks() {  stockService.getStocks(new AsyncCallback<String[]>() {
	public void onFailure(Throwable error) { handleError(error); }  public void onSuccess(String[] symbols) {
...
private void updateTable(StockPrice price) {
  ...
  //Display the timestamp showing last refresh time. 
...
private void addStock() {
    ...
    //Don't add the stock if already in the table.
